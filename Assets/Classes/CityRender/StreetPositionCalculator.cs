...
namespace CityRender
{
    ...
    {
        public static (List<Matrix4x4> street, List<Matrix4x4> edge) createStreet_Matrix4x4(
            GameObject parent,
            GameObject street,
            GameObject street_edge,
            float a,
            float b
        )
        {
            ...
            var t =
                ...
                + new Vector3(-b / 2 - edgeSize.y / 2 + 2.8f, 0, -streetSize.x / 2);
            var r = Quaternion.Euler(
                parent.transform.rotation.eulerAngles + new Vector3(-90, -90, 0)
            );
            ...
            t =
                parent.transform.position
                + new Vector3(-b / 2 - edgeSize.y / 2 + 2.8f, 0, a + streetSize.x / 2);
            ...
            for (int i = 0; i < streetCount; i++)
            {
                t =
                    parent.transform.position
                    + new Vector3(
                        -b / 2 + streetSize.y * scale / 2 + i * scale * streetSize.y,
                        0,
                        -streetSize.x / 2
                    );
                r = Quaternion.Euler(
            ...
            for (int i = 0; i < streetCount; i++)
            {
                t =
                    ...
                    + new Vector3(
                        -b / 2 - streetSize.x / 2,
                        0,
                        streetSize.y * scale / 2 + i * scale * streetSize.y
                    );
                r = Quaternion.Euler(
                    parent.transform.rotation.eulerAngles + new Vector3(-90, 0, 0)
                );
                s = new Vector3(1, scale, 1);
